...
import type { Point, CommonStyle } from '@/types/component';
 ...
 */
export function getRotatedPointCoordinate(style: CommonStyle, center: Point, name: string) {
...
export function changeStyleWithScale(value: number) {
    ...
    return multiply(value, divide(parseInt(String(editStore.canvasStyleData.scale)), 100))
}
