...
export default async function runAnimation($el: HTMLElement, animations: Animation[] = []) {
  const play: (animation: Animation) => Promise<void> = (animation: Animation) => new Promise(resolve => {
