import type { Point } from '@/types/component'
...
function calculateLeftTop(style: { rotate: number; width: number; height: number; left: number; top: number }, curPositon: { x: number; y: number }, proportion: number, needLockProportion: any, pointInfo: { symmetricPoint: any }) {
...
function calculateRightTop(style: { rotate: number; width: number; height: number; left: number; top: number }, curPositon: { x: number; y: number }, proportion: number, needLockProportion: any, pointInfo: { symmetricPoint: any }) {
    const { symmetricPoint } = pointInfo
    let newCenterPoint = getCenterPoint(curPositon, symmetricPoint)
...
function calculateRightBottom(style: { rotate: number; width: number; height: number; left: number; top: number }, curPositon: { x: number; y: number }, proportion: number, needLockProportion: any, pointInfo: { symmetricPoint: any }) {
    const { symmetricPoint } = pointInfo
    let newCenterPoint = getCenterPoint(curPositon, symmetricPoint)
...
function calculateLeftBottom(style: { rotate: number; width: number; height: number; left: number; top: number }, curPositon: { x: number; y: number }, proportion: number, needLockProportion: any, pointInfo: { symmetricPoint: any }) {
    const { symmetricPoint } = pointInfo
    let newCenterPoint = getCenterPoint(curPositon, symmetricPoint)
...
function calculateTop(style: { rotate: number; width: number; height: number; top: number; left: number }, curPositon: Point, proportion: number, needLockProportion: any, pointInfo: { symmetricPoint: any; curPoint: any }) {
...
function calculateRight(style: { rotate: number; height: number; width: number; top: number; left: number }, curPositon: Point, proportion: number, needLockProportion: any, pointInfo: { symmetricPoint: any; curPoint: any }) {
    const { symmetricPoint, curPoint } = pointInfo
    const rotatedcurPositon = calculateRotatedPointCoordinate(curPositon, curPoint, -style.rotate)
...
function calculateBottom(style: { rotate: number; width: number; height: number; top: number; left: number }, curPositon: Point, proportion: number, needLockProportion: any, pointInfo: { symmetricPoint: any; curPoint: any }) {
    const { symmetricPoint, curPoint } = pointInfo
    const rotatedcurPositon = calculateRotatedPointCoordinate(curPositon, curPoint, -style.rotate)
...
function calculateLeft(style: { rotate: number; height: number; width: number; top: number; left: number }, curPositon: Point, proportion: number, needLockProportion: any, pointInfo: { symmetricPoint: any; curPoint: any }) {
    const { symmetricPoint, curPoint } = pointInfo
    const rotatedcurPositon = calculateRotatedPointCoordinate(curPositon, curPoint, -style.rotate)
...
export type HandleDirection = keyof typeof funcs;

export default function calculateComponentPositionAndSize(name: HandleDirection, style: any, curPositon: { x: number; y: number }, proportion: number, needLockProportion: any, pointInfo: { center: { x: any; y: any }; curPoint: { x: number; y: number }; symmetricPoint: { x: number; y: number } }) {
